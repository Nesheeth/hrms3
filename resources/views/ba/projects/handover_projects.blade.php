						...
						<div class="table-responsive table-remove-padding">
							<table class="table  table-hover table-condensed" id="datatable">
								...
								<tbody>
								   ...
								   <tr>
								     <td> <a href="{{route('cm.edit_project',['role'=>getRole(Auth::user()->role),'id'=> $project->id])}}" > {{$project->project_id}} </a></td>
									 ...
									 <td>
									    <a href="{{route('cm.project_info',['role'=>getRole(Auth::user()->role),'id'=> $project->id])}}" class="btn btn-info"><i class="fa fa-eye"></i> View</a>
...
<script> 
 $(document).on('change','#sort_by',function(){
	 window.location.href = "{{ route('ba.handover_projects') }}"+"?&project_type="+ $(this).val();
 });
 ...
 $(document).on('change','#project',function(){
            ...
            message:$('<div> Please wait loading page...</div>').load('{{route("cm.project_history",["role"=>getRoleStr()])}}/'+project_id),
            buttons:[{ 
                label:"Close",
