          ...
          <table cellpadding="0" cellspacing="0" width="800" class="wrap">
            <tr>
                ...
                <table cellpadding="0" cellspacing="0" class="force-full-width">
                  <tr>
                   <td height="70" valign="top" class="header-cell">
                    <img width="196" height="60" src="{{URL('/images/cb-logo.png')}}" alt="logo" style="margin:15px;">
                  </td>
              ...
              <tr>
                <td valign="top" class="body-cell" colspan="2">
                  ...
                  <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                    <tr>
                      <td valign="top" style="padding-bottom:15px; background-color:#ffffff;">
                        <!-- <h1 style="padding-bottom:10px;">Mr. Abhishek Tripathi</h1>
                        <p><b>CEO</b></p>
                        <p><b>Coding Brains Software Solutions Pvt. Ltd.<br/>
                          Gomtinagar<br/>
                          Lucknow<br/>
                        Uttar Pradesh</b>
                      </p> -->
                  ...
                  <tr>
                    <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                     <!-- <b>16th January 2018</b> -->
                   </td>
                 </tr>
                 <tr>
                  <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                   <b>{{$user1->first_name}} {{$user1->last_name}}</b><br/>
                 ( {{getRoleById($user1->role)}} )<br/>
                 <b>Email : {{$user1->email}}</b>
               ...
               <tr>
                <td>
                  <table cellspacing="1" cellpadding="1" width="100%" bgcolor="#ffffff" BORDER="0" BORDERCOLORLIGHT="#C7F25F" >

                    <tbody style="background-color:#fff;">
                      <tr>
                        <td style="width:100%; text-align:left;">Your Resignation is Accepted. Thank You For Making A Part of 'CODING BRAINS' </td>
              ...
              <tr>
                ...
                <b>Amol Pandey</b><br/>
                 <b>Email :amol@codingbrains.com</b>
               </td>
             </tr>
           </table>
         </td>
