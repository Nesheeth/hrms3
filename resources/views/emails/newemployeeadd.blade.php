              ...
              <tr>
                   ...
                   <tr>
                    <td>
                      <table cellspacing="1" cellpadding="1" width="100%" bgcolor="#ffffff" BORDER="1" BORDERCOLORLIGHT="#C7F25F" >
                        <b>Welcome to coding brains <span class="text-success">{{$user_name}}</span>.</b><br>
                        <span class="text-success"> Your Login Details.</span><br>

                         user id - {{$details}} </br><br>
                         password - {{$password}}
                ...
                <tr>
                  <td style="padding-top:20px; background-color:#ffffff;">
                   ...
                   Amol Panday<br/>
                  <b> Email : amol@codingbrains.com </b><br/>
