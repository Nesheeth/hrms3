...
<head>
	...
	<title>CB-HRMS | Reset Password</title>
		...
		<tr>
						...
						<tr>
							<td valign="top" class="wrap-cell" style="padding-top:30px; padding-bottom:30px;">
								<table cellpadding="0" cellspacing="0" class="force-full-width">
									<tr>
										<td height="90" valign="top" class="header-cell">
                                  ...
                                  <div><!--[if mso]>
                                    <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:40px;v-text-anchor:middle;width:200px;" stroke="f" fillcolor="#008000">
                                      ...
                                      <center>
                                      <![endif]-->
                                      <a href="{{URL('/')}}/verify_reset_token/{{$confirmation_code}}"
                                      style="background-color:red;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:18px;line-height:40px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">
            ...
            <tr>
            	<td style="padding-top:20px;background-color:#ffffff;">
            		If you did not request a password reset, you can safely Ignore this email. Only a person with access to your email reset your account password.
            	</td>
            </tr>
        </table>
    </td>
