			...
			<div class="col-md-12">
				...
				<div class="panel panel-white info-box-re">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" method="post" action="{{URL(getRoleStr().'/retract/')}}" enctype="multipart/form-data" id="resignForm">
							...
							<div class="box-body">
                                ...
                                <input type="hidden" name="resignation_id" value="{{@$resignation}}" />  
