...
<div class="page-inner">
									...
									<tr>
										...
										<tr>									
											...
											<!-- <tr>
												...
												if(date('D', $curdate) == "Mon"){
													 $precurdate = strtotime('-3 day' , $curdate);
													
													//for ($i = 0 ; $i < 4 ; $i++) {
                                                     
													 //$precurdate3 = date('m/d/Y', $precurdate);
													  
													 $precurdate2 = date('m/d/Y',$precurdate);
													  if(isHoliday($precurdate2,$emp_type) == true){
													       //$precurdate = strtotime ( '-1 day' ,$precurdate);
													  	$precurdate -= 24 * 3600;
													...
													// }
                                                         ...
                                                         $precurdate = strtotime('-1 day' , $curdate);

													// 	for ($i = 0 ; $i < 4 ; $i++) {
                                                     
													//  //$precurdate3 = date('m/d/Y', $precurdate);
													  
													 $precurdate1 = date('m/d/Y',$precurdate);

													  if(isHoliday($precurdate1,$emp_type) == true){
													      $precurdate = strtotime ( '-1 day' ,$precurdate);
												...
												@elseif($curdate == $mydate || $precurdate == $mydate)

												<td><a class="btn btn-reponsive btn-primary UpdateAttendance" data-mydate="{{$date}}" data-emptype="{{$emptype}}" >Edit</a></td>
 ...
 <!-- Upload Attendance Model -->
	...
	$(document).ready(function(){
		...
		$(document).on('click','.UpdateAttendanceHr',function(){
