							...
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="text" class="datepicker form-control" id="start_date" name="from_date" value="{{$employee_project->from_date}}" placeholder="From Date">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="text" class="datepicker form-control" id="end_date" name="end_date" value="{{$employee_project->end_date}}" placeholder="Project End Date">
