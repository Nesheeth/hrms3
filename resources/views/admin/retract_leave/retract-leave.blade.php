				...
				<div class="panel panel-white">
					...
					<div class="panel-body">
						...
						<div class="table-responsive table-remove-padding">
                         <table class="table dataTable no-footer" id="datatable" role="grid" aria-describedby="datatable_info">
								...
								<tbody>
									...
									@foreach($leave_types as $retract)
									...
									<tr>
										...
										<td>
											...
											@if($retract->is_accept == 1)
											<span class="text-success">Accepted</span>

											@elseif($retract->is_accept == 0)
											<b class="text-warning">Pending</b>
											@elseif($retract->is_accept == -1)
											<b class="text-danger">Rejected</b>
											@endif

										</td>

										<td><a href="javascript::void()" onclick="view({{$retract->leave_id}})" class="btn btn-primary"><i class="fa fa-eye"></i>View</a></td>
