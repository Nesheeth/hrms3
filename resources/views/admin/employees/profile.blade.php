...
<div class="page-inner">
	...
	<div id="main-wrapper">
		...
		<div class="row">
			...
			<div class="col-md-12">
              <table>
				<tr><a href="{{URL('admin/employee/'.$employee->id)}}" class="btn btn-danger pull-right">Edit Profile</a></tr>
               <!--  @if(date('d') == 3 && $update_date < $current_date)
					
						<tr><a href="{{url('/leavecount/'.$employee->id)}}" class="btn btn-info pull-right" id="" >Update Leave info</a></tr>
						@else
						...
						<div class="table-responsive">
							...
							<table  class="display table" style="width: 100%; cellspacing: 0;">
                                ...
                                <td>Available Leave(days)</td>
										<td>{{$employee->cb_profile->avail_leaves}}</td>
										...
										<div class="tab-pane fade" id="tab3">
											...
											<div class="row">
												...
												<div class="form-group col-md-6">
													...
													<p>
														@if(isset($employee->previous_employment->total_experience))
														{{$employee->previous_employment->total_experience}}
													@endif</p>
												...
												<div class="form-group  col-md-6">
													...
													<address>
														...
														<p>@if(isset($employee->previous_employment->last_company_details))
															{{$employee->previous_employment->last_company_details}}</p>
                                                        @endif
													</address>
												...
												<div class="form-group col-md-6">
													...
													<p>@if(isset($employee->previous_employment->last_company_joining_date))
														{{$employee->previous_employment->last_company_joining_date}}
														@endif
													</p>
												...
												<div class="form-group col-md-6">
													...
													<p>@if(isset($employee->previous_employment->last_company_relieving))
														{{$employee->previous_employment->last_company_relieving}}
													@endif</p>
												...
												<div class="form-group col-md-6">
													...
													<p>@if(isset($employee->previous_employment->last_company_salary))
														{{$employee->previous_employment->last_company_salary}}
													@endif</p>
												...
												<div class="form-group col-md-6">
													...
													<p>@if(isset($employee->previous_employment->first_join_date))
														{{$employee->previous_employment->first_join_date}}
													@endif</p>
