			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-body">
						<form class="form-horizontal" action="{{URL('/admin/leave-type/update')}}" method="post" enctype="multipart/form-data">
							<div class="box-body">
								{{csrf_field()}}
							...
							<div class="box-footer">
								<a href="{{URL('/admin/leave-types')}}" class="btn btn-default">Cancel</a>
