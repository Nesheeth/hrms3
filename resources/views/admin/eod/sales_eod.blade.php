								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<!-- <a onclick="return confirm('Are you sure, You want to delete EOD ?')" class="btn btn-danger btn-sm" href="{{route('admin.sales_eod_delete',['eod_id'=> $eod->id ])}}">  Delete </a> -->
										</td> 
									</tr>
									@endforeach
									</tbody>
	...
	$(document).ready(function(){ 
		 $(document).on('click','.eod_details',function(){  
		 	var id = $(this).attr('rel');
		 	    $.ajax({
		 	    	url:"{{route('admin.sales_eod_details')}}", 
		 	    	type:"GET",
		 	    	data:{id:id},
