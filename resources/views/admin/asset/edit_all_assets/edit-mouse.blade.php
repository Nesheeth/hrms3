	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Update Asset Mouse</li>
			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-heading clearfix">
						...
						<h4 class="panel-title">Update Asset Mouse</h4>
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" method="post" action="{{URL('/admin/mouse/update')}}" enctype="multipart/form-data">
...
<div class="col-sm-10">
<textarea name="asset_comment" id="asset_comment" cols="30" rows="10" class="form-control" placeholder="Mouse Comments" spellcheck="false">{{$asset->comment}}
</textarea>
</div>
</div>
