	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Update Asset Cabinet</li>
			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-heading clearfix">
						...
						<h4 class="panel-title">Update Asset Cabinet</h4>
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" method="post" action="{{URL('/admin/cabinet/update')}}" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<select name="asset" id="asset" class="form-control select2"  required="required" >
											...
											<option class="nsns" value="{{$asset->asset_id}}">{{$asset->asset->name}}</option>
...
<div class="form-group">
<label for="comment" class="col-sm-2 control-label">Comment / Reason</label>
<div class="col-sm-10">
<textarea name="asset_comment" id="asset_comment" cols="30" rows="10" class="form-control" placeholder="Cabinet Comments" spellcheck="false">{{$asset->comment}}
</textarea>
</div>
</div>
