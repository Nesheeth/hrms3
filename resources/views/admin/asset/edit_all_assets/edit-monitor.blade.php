			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" method="post" action="{{URL('/admin/monitor/update')}}" enctype="multipart/form-data">
...
<div class="col-sm-10">
<textarea name="asset_comment" id="asset_comment" cols="30" rows="10" class="form-control" placeholder="Monitor Comments" spellcheck="false">{{$asset->comment}}
</textarea>
</div>
</div>
