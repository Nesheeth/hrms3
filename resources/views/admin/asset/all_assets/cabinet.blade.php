			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					<div class="panel-heading clearfix">
						<a href="{{URL('/admin/export/asset-sheet-cabinet')}}" class="btn btn-danger pull-right" style="margin-top: -16px;margin-right: 10px;">Export Assets</a>
							...
							<table class="table"  id="datatable">
								...
								<tbody>
									...
									<tr>
										...
										<td>{{$asset->status}}</td>
										<td><a class="btn btn-primary" href="{{URL('/admin/cabinet/'.$asset->id)}}">Edit</a></td>
...
<script>
	...
	$('#uploadAsset').on('click',function(){
		...
		if(assetFile.files[0]) {
			...
			var url  = "{{URL('/admin/import_cabinet/asset-sheet')}}";
			$.ajax({
				url: url,
				type: 'POST',
				data: form_data,
