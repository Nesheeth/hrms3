			...
			<div class="col-md-8">
				...
				<div class="panel panel-white">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" action="{{URL('/admin/system/update/'.'5')}}" method="post" enctype="multipart/form-data">
							...
							<div class="box-footer">
								...
								<a href="{{URL('/admin/systems')}}"  class="btn btn-default">Cancel</a>
							...
							<table class="table">
								...
								<tbody>
									...
									<tr>
										...
										<td><a class="btn btn-success" href="{{URL('/admin/release-system-asset/'.$system_asset->system_id.'/'.$system_asset->id.'/'.$system_asset->asset_type_id.'/'.$system_asset->master_asset_id)}}">Release</a></td>
...
<script>
	...
	$(document).ready(function() {
		...
		$("#asset_type1").on('change',function(e){
			...
			url = "{{URL('admin/getAssetByAssetType_unique/')}}";
		...
		$("#assignAssetBtn").on('click',function(e){
			...
			if(asset_type1 == ""){
				...
				url = "{{URL('admin/assignAsset_mac_mini/')}}";

				$.get(url+'/'+system_id+'/'+asset_id+'/'+asset_assoc_id, function(data) {
