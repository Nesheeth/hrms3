	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Update IMac</li>
			...
			<div class="col-md-8">
				...
				<div class="panel panel-white">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" action="{{URL('/admin/system/update/'.'6')}}" method="post" enctype="multipart/form-data">
	...
	$(document).ready(function() {
		...
		$("#assignAssetBtn").on('click',function(e){
			...
			if(asset_type1 == ""){
				...
				url = "{{URL('admin/assignAsset_i_mac/')}}";
