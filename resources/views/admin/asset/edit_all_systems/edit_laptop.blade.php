			...
			<div class="col-md-8">
				...
				<div class="panel panel-white">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" action="{{URL('/admin/system/update/'.'4')}}" method="post" enctype="multipart/form-data">
	...
	$(document).ready(function() {
		...
		$("#assignAssetBtn").on('click',function(e){
			...
			if(asset_type1 == ""){
				...
				url = "{{URL('admin/assignAsset_laptop/')}}";
