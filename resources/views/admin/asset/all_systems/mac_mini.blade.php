	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			...
			<ol class="breadcrumb">
				...
				<li class="active"><a href="{{URL('/admin/assets/all_system')}}">System</a></li>
			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-heading clearfix">
						...
						<a href="{{URL('/admin/export_mac_mini/system-sheet')}}" class="btn btn-danger pull-right" style="margin-top: -16px;margin-right: 10px;">Export Systems</a>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<a class="btn btn-primary " href="{{URL('/admin/system/'.$system->id.'/'.$system->master_system_id)}}">Edit</a>

										</td>

                                         <td style ="display:none;">{{getAssetDescriptionsById(getSystemAssetById($system->id))}}</td>
                                         <td >{{getUserById($system->last_updated_by)->first_name}}
                                          	{{getUserById($system->last_updated_by)->last_name}}</td>
...
<script>
	...
	function releasesystem(system_id){
		...
		var url = "{{URL('admin/systemRelease/')}}";
	...
	$('#uploadsystem').on('click',function(){
		...
		if(systemFile.files[0]) {
			...
			var url  = "{{URL('/admin/import/system-sheet')}}";
