	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			...
			<ol class="breadcrumb">
				...
				<li class="active"><a href="{{URL('/admin/assets')}}">Asset</a></li>
			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-heading clearfix">
						...
						<a href="{{URL('/admin/export/asset-sheet')}}" class="btn btn-danger pull-right" style="margin-top: -16px;margin-right: 10px;">Export Assets</a>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<a href="{{URL('/admin/system/'.$asset->system_id)}}">{{getSystemById($asset->system_id)['name']}} {{getSystemById($asset->system_id)['system_id']}}</a></td>
										...
										<td><a class="btn btn-primary" href="{{URL('/admin/asset/'.$asset->id)}}">Edit</a></td>
										<td>{{getUserById($asset->last_editing_by)['first_name']}}</a></td>
...
<script>
	...
	$('#uploadAsset').on('click',function(){
		...
		if(assetFile.files[0]) {
			...
			var url  = "{{URL('/admin/import/asset-sheet')}}";
