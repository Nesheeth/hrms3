	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			...
			<ol class="breadcrumb">
				...
				<li><a href="{{URL('/admin/assets')}}">Asset</a></li>
			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" method="post" action="{{URL('/admin/asset/update')}}" enctype="multipart/form-data">
							...
							<div class="box-footer">
								...
								<a href="{{URL('/admin/assets')}}" class="btn btn-default">Cancel</a>
