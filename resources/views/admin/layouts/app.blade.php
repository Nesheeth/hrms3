    ...
    <main class="page-content content-wrap">
      <div class="navbar">
        <div class="navbar-inner">
          ...
          <div class="logo-box">
            <a href="{{URL('/admin/dashboard')}}" class="logo-text"><span>CB-HRMS</span></a>
          </div><!-- Logo Box -->
              ...
              <ul class="nav navbar-nav navbar-right">
               <!-- <li class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-list" role="menu">
                    ...
                    <li><a href="#">Angular Admin</a></li>
                    <li><a href="#">PSD to HTML</a></li>
                    <li><a href="#">iOs App Development</a></li>
                  </ul>
                </li> -->
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Reports</a>
                  <ul class="dropdown-menu dropdown-list" role="menu">
                    <li><a href="#"><i class="fa fa-file-excel-o"></i>MS Excel</a></li>
                    <li><a href="#"><i class="fa fa-file-word-o"></i> MS Word</a></li>
                    <li><a href="#"><i class="fa fa-file-pdf-o"></i>PDF</a></li>
                  </ul>
                </li>
                <li>
                  <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown"><i class="fa fa-bell"></i><span class="badge-success nav-unread"><!-- {{ getUnreadNotificationsById(\Auth::user()->id) }} --></span></a>
                  ...
                  <ul class="dropdown-menu title-caret dropdown-lg" role="menu">
                    ...
                    <li class="drop-all"><a href="{{URL('/admin/view-notification')}}" class="text-center">All Notification</a></li>
                  </ul>
                </li>
                <li>
                  <a href="#"><i class="fa fa-envelope"></i>
                    <span class="badge-primary nav-unread"></span>
                  </a>
                </li>
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-list" role="menu">
                    ...
                    <!-- <li><a href="#"><i class="icon-envelope-letter"></i> Inbox <span class="fltright"><span class="badge badge-primary">6</span></span></a></li> -->
                    @if(Auth::user()->role==1)
                    ...
                    @endif
                    <li><a href="{{$url}}"><i class="icon-calendar"></i> Holiday Calendar</a></li>
                    <li><a href="#"><i class="icon-paper-plane"></i> Message</a></li>
