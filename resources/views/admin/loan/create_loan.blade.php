								...
								<tbody>
								   ...
								   <tr>
									 ...
									 <td>
									    ...
									    <button rel="" class="btn btn-primary team"><i class="fa fa-users" aria-hidden="true"></i> Team </button>
									    <button rel="" class="btn btn-success reminder"><i class="fa fa-users" aria-hidden="true"></i> Add Reminder </button>
									  </td>
								   </tr>
