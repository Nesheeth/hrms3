...
<div class="page-inner">
    ...
    <div id="main-wrapper">
		<div class="row">
			<div class="col-md-12">
				<a href="{{URL('sales/'.getRoleStr().'/profile/edit')}}" class="btn btn-danger pull-right"><i class="fa fa-plus"></i> Edit Profile</a>
            </div>
        </div>
										...
										<div class="tab-pane fade" id="tab3">
											...
											<div class="row" id="pre">
												<div class="form-group col-md-5">
													...
													<p>@if(isset($employee->previous_employment->total_experience)){{$employee->previous_employment->total_experience}}@endif</p>
												</div>
												<div class="form-group  col-md-5">
													<label for="last_company_details">Last Company Details</label>
													<address>
														<p>@if(isset($employee->previous_employment->last_company_details))
															{{$employee->previous_employment->last_company_details}}
														@endif</p>
													</address>
												</div>
												<div class="form-group col-md-5">
												...
												<div class="form-group col-md-5">
													...
													<p>@if(isset($employee->previous_employment->last_company_salary)){{$employee->previous_employment->first_join_date}}
													@endif</p>
												</div>
