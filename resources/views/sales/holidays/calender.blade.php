 ...
 <script>
    $(document).on('click','.view',function(){ 
        ...
        BootstrapDialog.show({
            ...
            message: $('<div> Please wait loading page...</div>').load("{{route('salescalender',[getRoleStr()])}}"),   
            buttons:[{   
                label:"view",
                ...
                action: function(dialog){  
                   ...
                   /*========================================================*/
                         BootstrapDialog.show({
                              ...
                              message: $('<div> Please wait loading page...</div>').load("{{route('salescalenderdata',[getRoleStr()])}}?month="+month+"&year="+year),   
                              buttons:[{   
                                  label:"close",
