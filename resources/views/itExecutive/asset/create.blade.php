					...
					<div class="panel-body">
						...
						<form class="form-horizontal" method="post" enctype="multipart/form-data" novalidate>
							...
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="text" name="purchase_from_store" id="purchase_from_store" class="form-control ">
							...
							<div class="box-footer">
								...
								<a href="" onclick="window.history.back(-1);" class="btn btn-default"> Cancel </a>  
