			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-heading clearfix">
						...
						<a href="{{URL('/itExecutive/export/asset-sheet-mac_mini')}}" class="btn btn-danger pull-right" style="margin-top: -16px;margin-right: 10px;">Export Assets</a>
							...
							<table class="table"  id="datatable">
								...
								<tbody>
									...
									<tr>
										...
										<td><a class="btn btn-primary" href="{{URL('/itExecutive/mac_mini/'.$asset->id)}}">Edit</a></td>
...
<script>
	...
	$('#uploadAsset').on('click',function(){
		...
		if(assetFile.files[0]) {
			...
			var url  = "{{URL('/itExecutive/import_mac_mini/asset-sheet')}}";
