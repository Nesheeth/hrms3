			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" action="{{URL('/itExecutive/assets/all_assets')}}" method="post" enctype="multipart/form-data" id="form" >
							...
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<select name="asset_type" id="asset_type" class="form-control select2" >
