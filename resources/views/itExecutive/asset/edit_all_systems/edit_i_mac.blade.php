			...
			<div class="col-md-8">
				...
				<div class="panel panel-white">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" action="{{URL('/itExecutive/system/update/'.'6')}}" method="post" enctype="multipart/form-data">
							...
							<div class="box-footer">
								...
								<a href="{{URL('/itExecutive/assets/all_system')}}" target="_blank" class="btn btn-default">Cancel</a>
	...
	$(document).ready(function() {
		...
		$("#assignAssetBtn").on('click',function(e){
			...
			if(asset_type1 == ""){
				...
				url = "{{URL('itExecutive/assignAsset_i_mac/')}}";
