	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			...
			<ol class="breadcrumb">
				...
				<li><a href="{{URL('/itExecutive/assets')}}">Asset</a></li>
			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-heading clearfix">
						...
						<h4 class="panel-title">Update Asset</h4>
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" method="post" action="{{URL('/itExecutive/asset/update')}}" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<select name="asset_type" id="asset_type" class="form-control select2"  required="required">
											...
											<option value="{{$asset_type->id}}" {{$asset_type->id == $asset->asset_type_id?"selected":""}}>{{$asset_type->type}}</option>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<select name="asset" id="asset" class="form-control select2"  required="required">
											...
											@foreach($asset_assocs as $asset_assoc )



											<option value="{{$asset_assoc->id}}" {{$asset_assoc->id == $asset->asset_id?"selected":""}}>{{$asset_assoc->name}}</option>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<select class="form-control select2" name="system_id" id="system_id" style="width: 100%;">
											...
											<option value="{{$system->id}}" {{$asset->system_id == $system->id ? "selected":""}}>{{$system->name}} {{$system->system_id}}</option>
							...
							<div class="box-footer">
								...
								{{--<a href="{{URL('/itExecutive/assets')}}" target="_self" class="btn btn-default">Cancel</a>--}}
