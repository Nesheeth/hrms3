	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Update Asset Monitor</li>
			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-heading clearfix">
						...
						<h4 class="panel-title">Update Asset Monitor</h4>
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" method="post" action="{{URL('/itExecutive/monitor/update')}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-10">
										...
										<select class="form-control select2" name="system_type_id" id="system_type_id" style="width: 100%;">
											...
											<option value="{{$system_type->id}}" @if($system_type->id == $system_type->asset_type_id) selected @endif>{{$system_type->name}} </option>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<select class="form-control select2" name="system_id" id="system_id" style="width: 100%;">
                                            ...
                                            @if($asset->system_code)

                                            <option value="{{$asset->system_id}}">{{$asset->system_code}}</option>
