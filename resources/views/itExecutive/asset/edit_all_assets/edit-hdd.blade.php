	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Update Asset Hdd</li>
			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-heading clearfix">
						...
						<h4 class="panel-title">Update Asset Hdd</h4>
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" method="post" action="{{URL('/itExecutive/hdd/update')}}" enctype="multipart/form-data">
							...
							<div class="box-footer">
								...
								<a href="{{URL('/itExecutive/assets')}}" class="btn btn-default">Cancel</a>
