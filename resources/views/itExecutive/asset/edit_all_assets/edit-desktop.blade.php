	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Update Asset Desktop</li>
			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-heading clearfix">
						...
						<h4 class="panel-title">Update Asset Desktop</h4>
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" method="post" action="{{URL('/itExecutive/desktop/update')}}" enctype="multipart/form-data">
							...
							<div class="box-footer"> 
								...
								<a href="" target="_self" onclick="window.history.go(-1); return false;" class="btn btn-default">Cancel</a>
