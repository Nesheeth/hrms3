	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			...
			<ol class="breadcrumb">
				...
				<li><a href="{{URL('/itExecutive/assets/all_assets')}}">Asset</a></li>



				<li class="active">Update Asset Keyboard</li>
			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-heading clearfix">
						...
						<h4 class="panel-title">Update Asset Keyboard</h4>
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" method="post" action="{{URL('/itExecutive/keyboard/update')}}" enctype="multipart/form-data">
							...
							<div class="box-body">
                                ...
                                <div class="form-group" id="damaged_cmt">
									<label for="repair_replacement_date" class="col-sm-2 control-label">Damaged Comments  </label>
									<div class="col-sm-10">
										<textarea name="comments" id="comments" class="form-control">{{$asset->comments}}</textarea>
...
<script>
	$(document).ready(function() {
		...
		$(document).on('change','#asset_status',function(){
...
$('#system_type_id').change(function(){
           ...
           var asset_type_id =  $('#asset').val(); 
            ...
            url = "{{URL('itExecutive/systemBySystemType/')}}";
