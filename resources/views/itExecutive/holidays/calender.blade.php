 ...
 <script>
    $(document).on('click','.view',function(){ 
        ...
        BootstrapDialog.show({
            ...
            message: $('<div> Please wait loading page...</div>').load("{{route('itExecutivecalender')}}"),   
            buttons:[{   
                label:"view",
                ...
                action: function(dialog){  
                   ...
                   /*========================================================*/
                         BootstrapDialog.show({
                              ...
                              message: $('<div> Please wait loading page...</div>').load("{{route('itExecutivecalenderdata')}}?month="+month+"&year="+year),   
                              buttons:[{   
                                  label:"close",
