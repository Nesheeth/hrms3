							...
							<table class="table" id="datatable">
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="{{URL('/teamLead/project/'.$project->id)}}">{{getProjectById($project->id)->name}}</a></td>

											<td>{{getUserById($project->user_id)['first_name']}}</td>

												<td>{{getUserById($project->reporting_to)['first_name']}} {{getUserById($project->reporting_to)['last_name']}}</td>
										...
										<td>
											...
											<a href="{{URL('/teamLead/project/'.$project->id)}}" class="btn btn-primary">View</a>
