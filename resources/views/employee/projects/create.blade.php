	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			<ol class="breadcrumb">
				...
				<li><a href="{{URL('/teamLead/projects')}}">Projects</a></li>
						...
						<form class="form-horizontal" method="post" enctype="multipart/form-data">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="datepicker form-control" name="start_date" placeholder="Project Start Date">
							...
							<div class="box-footer">
								<a href="{{URL('/teamLead/projects')}}" class="btn btn-default">Cancel</a>
