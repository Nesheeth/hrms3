	...
	<body class="page-header-fixed">
		...
		<div class="menu-wrap">
			...
			<nav class="profile-menu">
				...
				<div class="profile"><img src="" width="60" alt="David Green"/><span>David Green</span></div>
			...
			<div class="navbar">
				...
				<div class="navbar-inner">
					...
					<div class="logo-box">
						...
						<a href="{{URL(getRoleStr().'/dashboard')}}" class="logo-text"><span>CB-HRMS</span></a>
							...
							<ul class="nav navbar-nav navbar-right">
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu title-caret dropdown-lg" role="menu">
										...
										<li><p class="drop-title">You have <span id="unreadMsg">{{ getUnreadNotificationsById(\Auth::user()->id)}}</span> notification !</p></li>
										...
										<li class="drop-all"><a href="{{URL('/employee/view-notification')}}" class="text-center">All Notification</a></li>
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu dropdown-list" role="menu">
										...
										<li role="presentation"><a href="{{URL('/employee/holiday-calender')}}"><i class="fa fa-calendar"></i>Holiday Calendar</a></li>
										...
										<li role="presentation"><a href="#" data-toggle="modal" data-target="#myModal-emp"><i class="fa fa-pencil m-r-xs"></i>Change Password</a></li>
		...
		{{-- 	<!-- change password Modal -->
			...
			<div class="modal fade empList-modal-lg changePassModal" id="myModal-emp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		@include('employee.layouts.footer_navbar')
				...
				$.ajax({
					...
					success: function (data) {
						...
						if(data.flag){
							...
							$('#notificationMessage').html(data.notification.message);
		...
		<?php  
		$mydate = date('Y-m-d');  
		$employee_id = Auth::user()->cb_profile->employee_id;
		?>
