	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="active" {{ (Auth::user()->is_active==1)?'':'disabled' }}>Apply Leave</li>
			</ol>
		</div>
	</div>
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" method="post">
							...
							<div class="box-body">
									...
									<div class="col-sm-10">
										...
										<select name="leave_type" id="leave_type" class="form-control select2">
											...
											<option value="{{$leave_type->id}}" 
												{{ (old('leave_type')==$leave_type->id)?'Selected' : ''}}>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input  class="form-control datepicker" value="{{old('date_from')}}" name="date_from" id="date_from" placeholder="Date From">
								...
								<div class="form-group date_to">
									...
									<div class="col-sm-10">
										...
										<input class="form-control datepicker" value="{{old('date_to')}}" name="date_to" id="date_to" placeholder="Date To"> 
								...
								<div class="form-group days">
									...
									<div class="col-sm-10">
										...
										<input type="text" class="form-control" name="days" value="{{old('days')}}" id="days" readonly="readonly">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="text" onkeypress='return event.charCode >= 46 && event.charCode <= 57 || event.key === "Backspace"' class="form-control" name="contact_number" value="{{old('contact_number')}}" id="Contact Number">
							...
							<div class="box-footer">
								...
								<a href="{{ route('em.my_leave',['role'=> getRoleStr()]) }}" class="btn btn-default">Cancel</a>
