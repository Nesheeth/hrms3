...
<style>
	...
	.per-bor label {font-size: 20px;padding: 15px 0px 10px 0px;}
	#profile-page label {font-size: 16px;font-weight: 800;}
	#profile-page p {font-size:  15px;}
</style>
                                 ...
                                 <div class="row m-b-lg">
                                    <div class="row">
                                       ...
                                       <div class="form-group  col-md-12">
                                          ...
                                          <address>
                                             <p>{{$employee->personal_profile->address}}</p>
                                          </address>
                                       </div>
                                       <div class="form-group  col-md-6">
...
<div style="visibility: hidden;" id="newRow">
	<div class="row" id="new"> 
	   <div class="form-group  col-md-5">
	      <label for="last_company_details">Company Name</label><br>
	      <input type="text" class="form-control" name="last_company_details[]" required />
	   </div>
	   <div class="form-group col-md-5">
	      <label for="last_company_joining_date">Last Company Join Date</label><br>
	      <input type="text" id="datepicker2" class="datepicker form-control" name="last_company_joining_date[]" required/>
	   </div>
	   <div class="form-group col-md-5">
	      <label for="last_company_relieving">Last Company Relieving Date</label><br>
	      <input type="text"  id="datepicker1" class="datepicker form-control" name="last_company_relieving[]" required/>
	   </div>
	   <div class="form-group col-md-5">
	      <label for="last_company_salary">Company Salary</label><br>
	      <input type="text" class="form-control" name="last_company_salary[]" required/>
	   </div>
	   <div class="form-group col-md-1">
