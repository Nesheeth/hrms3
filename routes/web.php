...
/* ------------------ Sales Team URLs ----------- */
Route::group(['prefix' => 'sales/{role}','middleware' => ['auth'] ], function(){

	Route::get('/readNotification/{id}','SalesTeamController@notification');   
	Route::get('/notifications','SalesTeamController@view_notification');
	Route::get('profile/edit', 'SalesTeamController@getProfileEdit');
	Route::post('profile/edit', 'SalesTeamController@postProfileEdit');
	Route::get('/sent-eods', 'SalesTeamController@sent_eod');
	Route::post('action-leave','SalesTeamController@changeleavestatus')->name('s1.change_leave_status');
	Route::get('/eod/delete/{id}', 'SalesTeamController@deleteSALES_EOD');
	Route::get('eods-details', 'SalesTeamController@eod_details')->name('sales.eod_details');
	Route::get('/team-member-leave-listing', 'SalesTeamController@leave_list')->name('salesleave');
	Route::get('dashboard','SalesTeamController@dashboard')->name('sl.dashboard'); 
	Route::get('leave-management','SalesTeamController@leave_mng')->name('sl.leave_mng');
	Route::get('salary','EmployeeController@salary')->name('sl.salary'); 
	Route::get('apply-leave', 'SalesTeamController@apply_leave')->name('sl.apply_leave');
	Route::get('my-leaves','SalesTeamController@my_leaves')->name('sl.my_leave'); 
	Route::post('apply-leave', 'LeaveManageController@apply_leavePost');
	Route::get('password-management','EmployeeController@password_mng')->name('sl.pw_mng');
	Route::get('holiday-calender', 'SalesTeamController@holidayCalender')->name('sl.holiday');
	Route::get('send-eod','EODController@send_sales_eods')->name('sl.send_eod');
	Route::get('see-team-eod', 'SalesTeamController@getSeeTeamEOD')->name('sales_team_eods');
	Route::post('send-eod','EODController@send_sales_eods_save')->name('sl.send_eodPost');      
	Route::get('eod-list','EODController@sales_eods')->name('sl.eods'); 
	Route::get('projects','SalesTeamController@projects_list')->name('sl.projects');
	Route::get('profile','SalesTeamController@profile')->name('sl.profile'); 
	Route::get('edit-profile','EmployeeController@getProfileEdit')->name('sl.edit_profile');    
	Route::post('edit-profile', 'EmployeeController@postProfileEdit'); 
	Route::get('/sales-calender','SalesTeamController@viewAttendance')->name('salescalender');
	Route::get('/sales-calender-data','SalesTeamController@calender')->name('salescalenderdata');
	//Route::get('/salary','EmployeeController@salary')->name('e.salary');         
});



Route::get('viewpayroll', 'PayrollController@view_payroll')->name('viewpayroll');
Route::get('calculate-monthly-salary', 'SalaryManageController@calculate_salary');

Route::group(['prefix' => '{role}','middleware' => ['auth'] ], function(){
	
	/*==================================== Report Routes ========================================*/

	   Route::get('review-projects','ReportController@emp_report')->name('c.get_report');
       Route::post('review-projects','ReportController@emp_reportPost')->name('c.get_report');
       Route::get('get-report-cart','ReportController@getReport')->name('tl.eReportCart');
	   Route::post('get-report-cart','ReportController@getReportPost')->name('tl.eReportCart');
       Route::post('/add-report','ReportController@add_report');
       Route::post('add-report-by-tl','ReportController@add_report_by_tl');
       Route::post('add-report-by-admin','ReportController@add_report_by_admin');

    /*================================= Report Routes End Here ===================================*/
	   
	   
	   Route::get('/view-notification', 'AdminController@view_notification');
       Route::get('apply-leave', 'LeaveManageController@apply_leave')->name('cm.apply_leave');
	   Route::post('apply-leave', 'LeaveManageController@apply_leavePost');
	   Route::get('re-apply-leave', 'LeaveManageController@re_apply_leavePost');
	   Route::get('my-leaves','LeaveManageController@my_leaves')->name('em.my_leave');
	   Route::get('leave-listing','LeaveManageController@leave_list')->name('cm.leave_list');
	   Route::get('leave-info/{id?}','LeaveManageController@leave_info')->name('cm.leave_info');
	    Route::get('retract-leave-info/{id?}','LeaveManageController@retract_leave_info')->name('cm.retract_leave_info');
	   Route::post('action-leave','LeaveManageController@changeleavestatus')->name('cm.change_leave_status');
	   Route::get('leave-retract','LeaveManageController@retract_leave')->name('em.retract_leave');
	   Route::get('retract-leave', 'LeaveManageController@retract_leave_list');
	  /*===================================== Project Routes ================================== */
	   Route::get('all-projects','ProjectManageController@project_lists')->name('cm.project_list');
	   Route::get('add-new-project','ProjectManageController@add_project')->name('cm.add_project');
	   Route::get('edit-project/{id}','ProjectManageController@add_project')->name('cm.edit_project');
	   Route::post('save-project','ProjectManageController@save_project')->name('cm.save_project');
	   Route::get('project-info/{id}','ProjectManageController@project_details')->name('cm.project_info');
	   Route::get('add-support-project/{project}','ProjectManageController@new_support_project')->name('cm.new_support_project');
	   Route::post('add-support-project','ProjectManageController@add_support_project')->name('cm.add_support_project');
	   Route::get('view-new-support','ProjectManageController@view_new_support')->name('cm.view_new_support');
	   Route::get('add-dedicated-project/{project}','ProjectManageController@new_dedicated_project')->name('cm.new_dedicated_project');
	   Route::post('save-dedicated-project','ProjectManageController@save_dedicated_project')->name('cm.save_dedicated_project');
	   Route::get('add-fixed-project/{project}/{fix_id?}','ProjectManageController@add_fixed_project')->name('cm.add_fixed_project');
	   Route::get('edit-fixed-project/{project}/{fix_id?}','ProjectManageController@add_fixed_project')->name('cm.edit_fixed_project');
	   Route::post('add-fixed-project','ProjectManageController@save_fixed_project')->name('cm.save_fixed_project');
	   Route::get('update-fixed-project/{project}','ProjectManageController@edit_all_fixed')->name('cm.edit_all_fixed');
	   Route::post('update-fixed-project','ProjectManageController@edit_all_fixedPost')->name('cm.edit_fixed');

	   Route::get('assign-project','ProjectManageController@assign_project')->name('cm.assign_project');
	   Route::post('assign-project','ProjectManageController@assign_projectPost')->name('cm.assign_project');
	   Route::get('get-project-emp-list','ProjectManageController@get_project_emp')->name('cm.get_project_emp');
	   Route::get('view-project-team/{project?}','ProjectManageController@view_project_team')->name('cm.view_project_team');
	   Route::get('assign-update','ProjectManageController@assign_update_page')->name('cm.assign_update_page');
	   Route::post('assign-update','ProjectManageController@assign_updatePost')->name('cm.assign_update_page');
	   Route::get('project-history/{project?}','ProjectManageController@project_history')->name('cm.project_history');
	   Route::get('my-projects','ProjectManageController@my_project')->name('cm.my_project');

	   Route::get('add-reminder','ProjectManageController@new_reminder')->name('cm.add_reminder');
	   Route::post('add-reminder','ProjectManageController@save_reminder')->name('cm.add_reminder');

	   Route::get('password-management','EmployeeController@password_mng')->name('cm.pw_mng');
	   Route::get('leave-management','LeaveManageController@leave_mng')->name('cm.leave_mng');

	   /*===================================== Project Routes ================================== */

	/*===================================== EODS Routes ================================== */
	     Route::get('send-eod','EODController@send_eods')->name('cm.send_eod');
	     Route::post('send-eod','EODController@save_eods')->name('cm.send_eod');
	     Route::get('edit-send-eod','EODController@edit_save_eods');
	     Route::get('see-team-eod', 'EODController@getSeeTeamEOD')->name('cm.team_eods');
	     Route::get('eods-details', 'EODController@eod_details')->name('admin.eod_details');
	     Route::get('edit-eods-details/{id}', 'EODController@edit_eod_details')->name('cm.eod_edit');
	     Route::post('see-team-eod', 'EODController@eod_list_filter')->name('cm.eod_filter');
	     Route::get('edit-eod', 'EODController@edit_eod');
	     Route::get('edit-eod-update-request-accept','EODController@edit_eod_update_request_accept');
	     Route::get('edit-eod-update-request-reject','EODController@edit_eod_update_request_reject');
	...
	/*===================================== EODS Routes ================================== */
	  ...
	  /*===================================== Payrolls Routes ================================== */
		     ...
		     Route::get('payrolls-employees-list','PayrollController@adminPayrollsEmp')->name('a.ePayroll');
		     Route::get('payrolls-list/{id}','PayrollController@payslipLists')->name('c.payroll');     
			 Route::get('payrolls-details/{id?}','PayrollController@payrollDetails')->name('c.payrolldetails'); 
			 Route::get('payroll-view', function(Request $request){ return view('common.payroll.dateview'); })->name('c.payrollview'); 

			 Route::get('payroll-view','PayrollController@view_ern')->name('ern_page');
			 Route::post('save_income_deduction','PayrollController@save_income_deduction')->name('save_income_deduction');
			 Route::post('delete_earning_deduction','PayrollController@delete_earning_deduction')->name('delete_earning_deduction');
			 Route::post('recalculate','PayrollController@recalculate')->name('recalculate');
			 Route::post('download_payslip','PayrollController@get_payslip_details_by_id')->name('download_payslip');
			 Route::get('payment-status','PayrollController@changePaymentStatus')->name('payment_status'); 
			 
			 /*===================================== Payrolls Routes ================================== */ 
			 Route::post('get-salary-earning','HrManagerController@getSalaryEarning')->name('geternings'); 

	Route::get('setting','AdminController@setting')->name('setting');
	Route::post('setting','AdminController@setting_post')->name('setting'); 
...
Route::get('payroll-pages/{type}','PayrollController@payroll_pages')->name('payroll_pages');
Route::get('payroll-status','PayrollController@changePayRollStatusEmp')->name('payroll_status'); 
Route::get('management-payroll-status','PayrollController@changePayRollStatus')->name('mg.payroll_status');

Route::group(['prefix' => 'businessAnalyst' ], function(){
		   Route::post('add-loan','LoanController@store');
		   Route::get('loan-management','LoanController@loan_management');
		   Route::get('dashboard','BusinessAnalystController@dashboard')->name('ba.dashboard');
		   Route::get('profile/edit', 'BusinessAnalystController@getProfileEdit');
		   Route::post('profile/edit', 'BusinessAnalystController@postProfileEdit');
		   Route::get('holiday-calender', 'EmployeeController@holidayCalender')->name('ba.holiday');
		   Route::get('/calender','EmployeeController@viewAttendance')->name('calender');

			Route::get('/calender-data','EmployeeController@calender')->name('calenderdata'); 
		   Route::get('handover-projects','ProjectManageController@hand_overs_projects')->name('ba.handover_projects');
});

Route::group(['prefix' => 'accountent' ], function(){
		   Route::get('loan-management','LoanController@loan_management');
		   Route::post('add-loan','LoanController@store');
		   Route::get('dashboard','AccountentController@dashboard')->name('ac.dashboard');
		   Route::get('holiday-calender', 'EmployeeController@holidayCalender')->name('ac.holiday');
		   //Route::get('holiday-calender', 'EmployeeController@holidayCalender');
});

Route::get('get-assets-list','ITExecutiveController@get_assets_list')->name('assets_list');
Route::get('previous-cmp-details','EmployeeController@importPreviuesCmpDetails')->name('hr.importExCmp');
...
Route::group(['middleware' => ['auth','admin']], function () {
	Route::post('/admin/update-previous-compony-details','HrManagerController@updatePreviousCompanyDetail');
	Route::post('/admin/delete-previous-compony-details','HrManagerController@deletePreviousComponyDetail');
	//Route::get('/admin/attendance-data-view','AttendanceController@viewAttendance')->name('list-attandance');
	Route::get('/admin/at-veiw-data','AttendanceController@viewAttendanceData');
	//incentive and deduction route
		Route::post('/admin/add-incentive','HrManagerController@addIncentive');
		Route::post('/admin/add-deductions','HrManagerController@addDeductions');
		Route::post('/admin/update-incentive','HrManagerController@updateIncentive');
		Route::post('admin/get-deduction','HrManagerController@getDeductions');
		Route::post('/admin/update-deductions','HrManagerController@updateDeductions');

		//Loans Route 
	Route::post('/admin/add-loan','LoanController@store');
	Route::get('/admin/loan-list','LoanController@loanlist');
	Route::post('/admin/edit_loan','LoanController@edit_loan');	
	Route::post('/admin/view_emi','LoanController@emilist');
	//end incentive deduction route

	Route::get('/admin/get-report-cart','ReportController@getReport')->name('a.eReportCart');
	Route::post('/admin/get-report-cart','ReportController@getReportPost')->name('a.eReportCart');
	Route::get('/admin/profile/edit','AdminController@getProfileEdit');

	 Route::get('/admin/password-management','EmployeeController@password_mng')->name('ad.pw_mng');
...
//	Route::post('/admin/settings','AdminController@setting_post')->name('setting');
	...
	Route::post('/admin/employee/update-pre-company-details', 'EmployeeController@previous_emp_details');
	...
	Route::get('/admin/it-executive-eods', 'EODController@it_eod_list')->name('admin.iteod'); 
	Route::get('/admin/sales-executive-eods', 'EODController@sales_eod_list')->name('admin.saleseod'); 

	Route::get('/admin/hr-eods-details', 'EODController@hr_eod_details')->name('admin.hr_eod_details');
	Route::get('/admin/it-eods-details', 'EODController@it_eod_details')->name('admin.it_eod_details');
	Route::get('/admin/sales-eods-details', 'EODController@sales_eod_details')->name('admin.sales_eod_details');
	...
	Route::get('/admin/it_eod/delete/{eod_id}', 'EODController@deleteIT_EOD')->name('admin.it_eod_delete');
	Route::get('/admin/sales_eod/delete/{eod_id}', 'EODController@deleteSALES_EOD')->name('admin.sales_eod_delete');
	/*==========================EOD routes ends==============================*/
...
Route::group(['middleware' => ['auth','employee']], function () {
	...
	Route::get('/employee/loan-management','LoanController@loan_management');
	Route::post('/employee/add-loan','LoanController@store');
	Route::post('/employee/edit-loan','LoanController@edit_loan');
	...
	Route::post('/employee/holiday-calender','EmployeeController@reasonLog')->name('reason');

	Route::get('/calender','EmployeeController@viewAttendance')->name('calender');

	Route::get('/calender-data','EmployeeController@calender')->name('calenderdata'); 

	Route::post('/calender-attendance-data','EmployeeController@calender')->name('calenderattendancedata');

	Route::get('/employee/assigned-projects', 'EmployeeController@getAssisnedProject');

	//Route::get('/employee/salary','EmployeeController@salary')->name('e.salary');   
	...
	Route::post('/teamLead/add-loan','LoanController@store');
	...
	//Route::get('/teamLead/leave-listing', 'HrManagerController@leave_listing');
	...
	// Route::get('/employee/retract','ResignController@previewRetract');
...
Route::get('get-daily-attendance','AttendanceController@get_daily_attendance')->name('daily_attendance');

Route::get('get-daily-attendance','AttendanceController@get_daily_attendance')->name('daily_attendance');
Route::post('update-daily-attendance','AttendanceController@update_daily_attendance')->name('update_daily_attendance');    

/*========================Hr Manager Dashboard starts========================*/

Route::group(['middleware' => ['auth','hrManager']], function () {
	Route::post('/hrManager/update-previous-compony-details','HrManagerController@updatePreviousCompanyDetail');
	Route::post('/hrManager/delete-previous-compony-details','HrManagerController@deletePreviousComponyDetail');
	Route::get('/hrManager/at-veiw-data','AttendanceController@viewAttendanceData');
	//incentive and deduction route
		Route::post('/hrManager/add-loan','LoanController@store');
		Route::get('/hrManager/loan-management','LoanController@loan_management');
		Route::post('/hrManager/add-incentive','HrManagerController@addIncentive');
		Route::post('/hrManager/add-deductions','HrManagerController@addDeductions');
		Route::post('/hrManager/update-incentive','HrManagerController@updateIncentive');
		Route::post('hrManager/get-deduction','HrManagerController@getDeductions');
		Route::post('/hrManager/update-deductions','HrManagerController@updateDeductions');
	...
	Route::get('/hrManager/salary','HrManagerController@salary')->name('hr.salary'); 

	Route::get('/hrManager/teams','HrManagerController@teams');

	Route::get('/calender','HrManagerController@viewAttendance')->name('hrcalender');

	Route::get('/calender-data','EmployeeController@calender')->name('hrcalenderdata'); 
	...
	Route::post('/hrManager/employee/update-pre-company-details', 'EmployeeController@previous_emp_details');
	...
	/*========================== HR EOD routes starts===========================*/

	Route::get('hrManager/send-hr-eod', 'HrManagerController@getSendEOD')->name('hr.send_eod');

	Route::post('hrManager/send-hr-eod', 'HrManagerController@postSendEOD');

	Route::get('hrManager/sent-hr-eods', 'HrManagerController@sent_eod')->name('hr.eods');
	...
	Route::get('/hrManager/resignation/retract/{id}', 'HrManagerController@retractResign');
	Route::get('/hrManager/resignation/submit/{id}', 'HrManagerController@submitResign');
	Route::get('/hrManager/retract/', 'HrManagerController@restract');
	Route::post('/hrManager/retract/', 'HrManagerController@postapplyretract');
...
Route::post('/itExecutive/eod-save', 'EODController@save_it_eods')->name('it.eod');
Route::get('itExecutive/sent-eods', 'EODController@it_eods')->name('it.eod_list');

Route::group(['middleware' => ['auth','itExecutive']], function () {
	//Route::get('/itExecutive/salary','EmployeeController@salary')->name('e.salary');   
	
	Route::post('/itExecutive/add-loan','LoanController@store');
	Route::get('/itExecutive/loan-management','LoanController@loan_management');
	...
	Route::get('/itExecutive-calender','ITExecutiveController@viewAttendance')->name('itExecutivecalender');
	Route::get('/itExecutive-calender-data','ITExecutiveController@calender')->name('itExecutivecalenderdata');     
...
Route::get('/teamLead/profile/edit', 'EmployeeController@getProfileEdit');
Route::post('/teamLead/profile/edit', 'EmployeeController@postProfileEdit');
Route::get('/teamLead/team-member-leave-listing', 'TeamLeadController@leave_list')->name('leave');
Route::get('/teamLead/loan-management','LoanController@loan_management');
//});
/*=======================IT Executive Dashboard Ends==========================*/


Route::get('request-for-slip','PayrollController@request_for_slip')->name('request_for_slip');

/*=======================Knowledge Transfer Router Starts Here============================*/

Route::get('knowledge-transfer','KnowledgeTransferController@kt_view');
Route::get('kt-transfer/{id}','KnowledgeTransferController@assign_kt_to_emp'); 
Route::post('kt-transfer/{id}','KnowledgeTransferController@assignkt')->name('kt_transfer');
Route::get('see-kt-transfer/{id}','KnowledgeTransferController@see_kt_of_emp');
Route::get('assign-kt','KnowledgeTransferController@assign_kt_to_emp');
Route::post('emp-remark/{id}','KnowledgeTransferController@emp_remark');

/*=======================Knowledge Transfer Router Ends Here==============================*/